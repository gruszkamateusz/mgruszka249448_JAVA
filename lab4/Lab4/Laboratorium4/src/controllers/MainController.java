...
public class MainController {
    ...
    public void btnActionHandler(ActionEvent event) throws IOException {
    	if(comboBoxKlasy.getSelectionModel().getSelectedIndex() != -1) {
        ...
        try {
            ...
            m1.invoke(o,inputDataTextArea.getText(),statusListener);
       
            m2.invoke(o);
                       
            String tekst = (String)m3.invoke(o);
    		...
    		alert.setTitle("Error8732");
    		alert.setHeaderText("Wybierz procesor do przetworzenia danych!!");
